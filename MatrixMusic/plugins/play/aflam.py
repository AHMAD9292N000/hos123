"""
        ...
        [InlineKeyboardButton("𝑺𝑶𝑼𝑹𝑪𝑬 Y Z N", url=f"https://t.me/F_U_01")],
"""
...
async def comedy(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("➥𝚂́𝙾𝚄𝚁𝙲𝙴 𝙻𝙾𝚃𝚄𝚂♲", url=f"https://t.me/F_U_01")],
...
async def drama(c: Client, m: CallbackQuery):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗘𝗭𝗔𝗥", url=f"https://t.me/UIU_II")],
